...
: "${TESTNET_CHECKER_CODE_ID:?TESTNET_CHECKER_CODE_ID is required}"
...
update_env_value() {
  ...
  echo "Updated $env_key for testnet daily run"
}

update_env_value "CHECKER_CODE_ID" "$TESTNET_CHECKER_CODE_ID"
